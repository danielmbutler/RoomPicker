...
public abstract class Hilt_RoomListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoomListFragment_GeneratedInjector) this.generatedComponent()).injectRoomListFragment(UnsafeCasts.<RoomListFragment>unsafeCast(this));
    }
  }
